...
export default function App() {
  ...
  useEffect(() => {
    if (currentUser) {
      if (rememberMe)
        save(STORAGE.SESSION, { username: currentUser.username, remember: true });
    } else {
  ...
  if (sortBy === 'priority') {
    ...
    shownTasks.sort((a, b) => order[a.priority] - order[b.priority]);
  }
  ...
  async function handleLogin(e) {
    ...
    if (rememberMe)
      save(STORAGE.SESSION, { username: user.username, remember: true });
    ...
    <div className="container">
      ...
      {page === 'login' && (
        <Login
          ...
          loginUserRef={loginUserRef}
          loginPassRef={loginPassRef}
